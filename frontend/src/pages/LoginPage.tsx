...
export default function LoginPage() {
  ...
  console.log("LoginPage rendering with role:", role)
  // const handleGoogleLogin = useGoogleLogin({
  //   onSuccess: handleGoogleSuccess,
  //   onError: () => setError('Google Sign-in failed.'),
  // })
  const handleGoogleLogin = () => console.log("Google Login clicked (disabled for debug)")
  ...
  return (
    <Shell onLogoClick={handleLogoClick}>
      ...
      <ManufacturerRegisterModal
        ...
        onSuccess={() => { setShowRegisterModal(false); navigate('/manufacturer/overview') }}
      />
      <BuyerRegisterModal
