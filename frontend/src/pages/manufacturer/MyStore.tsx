      ...
      <div className="p-6 lg:p-10 space-y-8">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <motion.div 
            ...
            className="flex items-center gap-5 p-5 bg-white rounded-[2rem] border border-[#E5E1DA] shadow-sm max-w-2xl"
          >
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center bg-[#FAF8F5] overflow-hidden border border-[#E5E1DA] flex-shrink-0">
              {mfrProfile?.logo ? (
                <img src={mfrProfile.logo} alt="Logo" className="w-full h-full object-contain" />
              ) : (
                <Store size={24} className="text-[#D4C4B8]" />
              )}
            </div>
